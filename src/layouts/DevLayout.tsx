...
import { Home, Car, Users, Settings, LogOut, Bell, PanelLeftClose, PanelLeftOpen } from "lucide-react";
      ...
      >
        <SidebarHeader className="py-6">
          <div className="flex items-center justify-between px-4">
            {!collapsed && (
              <Link to="/developer/dashboard" className="text-2xl font-bold text-[#210F37]">
        ...
        <SidebarContent>
          <SidebarItem
            ...
            active={location.pathname === "/developer/dashboard"}
          />
          <SidebarItem
            icon={<Car size="20" />}
            label="Vehicles"
            to="/developer/vehicles"
            active={location.pathname === "/developer/vehicles"}
          />
          <SidebarItem
            icon={<Users size="20" />}
            label="Users"
            to="/developer/users"
            active={location.pathname === "/developer/users"}
          />
          <SidebarItem
            icon={<Bell size="20" />}
            label="Alerts"
            to="/developer/alerts"
            active={location.pathname === "/developer/alerts"}
          />
          <SidebarItem
            icon={<Settings size="20" />}
            label="Profile"
            to="/developer/profile"
            active={location.pathname === "/developer/profile"}
          />
        </SidebarContent>
          ...
          <DropdownMenu>
              ...
              <div className="flex items-center p-2 rounded-md hover:bg-gray-100 cursor-pointer">
                ...
                {!collapsed && (
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-[#A55B4B]">Developer</p>
                  </div>
                )}
              </div>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="start" className="w-56">
              <DropdownMenuItem asChild>
                <Link to="/developer/profile" className="cursor-pointer">Profile</Link>
              </DropdownMenuItem>
